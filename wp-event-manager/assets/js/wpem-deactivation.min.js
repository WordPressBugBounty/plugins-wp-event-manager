...
`);let i=jQuery(this).serialize();jQuery.post(wpem_ajax.ajax_url,i+"&action=wpem_deactivation_form",function(t){t.success&&Deactivation.actions.deactivatePlugin()})}),jQuery("#skip-deactivate").on("click",function(){Deactivation.actions.deactivatePlugin()})},deactivatePlugin:function(){jQuery("#wpem-deactivation-popup .popup-content").html(`
